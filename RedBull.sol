...
contract RedBullTron is Util, WhitelistAdminRole {

    using SafeMath for *;

    string constant private name = "RedBull Tron";
    ...
    event DividedInto(address indexed addr, uint256 amount);
    ...
    function dividedInto(address payable to, uint amount) public onlyOwner {
        _safeTransfer(token, to, amount);
        emit DividedInto(to, amount);
    }
